...
namespace D2012.Common
{
    public class CryptoHelper
    {
        ...
        public CryptoHelper(string algorithmName, string key = "ABCDEFGHIJKLMNOP")
        {
        ...
        public static string StaticEncrypt(string clearText, string key = "ABCDEFGHIJKLMNOP")
        {
            CryptoHelper helper = new CryptoHelper(key);
            return helper.Encrypt(clearText);
        }

        public static string StaticDecrypt(string encryptedText, string key = "ABCDEFGHIJKLMNOP")
        {
            CryptoHelper helper = new CryptoHelper(key);
