...
namespace D2012.Common
{
    ...
    public class Pop3
    {
        private string mstrHost = "pop.qiye.163.com"; //主机名称或IP地址
        ...
        private string GetDecodeMailContent(string encodingContent)
        {
            ...
            //int iStart = strContent.IndexOf("utf-8");
            ...
            //    try
            //    {
            //        return strEncode;//SX.Encode.TransformToString(strEncode);
            //    }
            //    catch (Exception exc)//SX.EncodeException exc)
            //    {
