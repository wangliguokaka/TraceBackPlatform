...
namespace D2012.DBUtility.Data.Core.SQLCore
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        {
            string sql = "select count(1) from syscolumns where [id]=object_id('"
                + tableName + "') and [name]='" + columnName + "'";
        ...
        /// <returns></returns>
        public static bool TabExists(string strTableName)
        {
            string strsql = "select count(*) from sysobjects where id = object_id(N'["
                + strTableName + "]') and OBJECTPROPERTY(id, N'IsUserTable') = 1";
        ...
        /// <returns></returns>
        public static int ExecuteSqlByTime(string strSQLString, int intTimes)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand(strSQLString, connection))
        ...
        /// <returns>影响的记录数</returns>
        public static int ExecuteSql(string strSQLString, string content)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
        ...
        /// <param name="content">参数内容,比如一个字段是格式复杂的文章，有特殊符号，可以通过这个方式添加</param>
        /// <returns>影响的记录数</returns>
        public static object ExecuteSqlGet(string strSQLString, string content)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand(strSQLString, connection);
        ...
        public static object GetSingle(string strSQLString)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand(strSQLString, connection))
        ...
        /// <param name="intTimes">时间</param>
        /// <returns></returns>
        public static object GetSingle(string strSQLString, int intTimes)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand(strSQLString, connection))
        ...
        public static DataSet Query(string strSQLString)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
        ...
        /// <param name="intTimes">时间</param>
        /// <returns></returns>
        public static DataSet Query(string strSQLString, int intTimes)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                DataSet ds = new DataSet();
        ...
        /// <returns>影响的记录数</returns>
        public static int ExecuteSql(string strSQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
        ...
        /// <param name="cmdParms">参数</param>
        /// <returns>查询结果（object）</returns>
        public static object GetSingle(string strSQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand())
        ...
        /// <param name="cmdParms">参数</param>
        /// <returns>SqlDataReader</returns>
        public static SqlDataReader ExecuteReader(string strSQLString, params SqlParameter[] cmdParms)
        {
            SqlConnection connection = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand();
            try
        ...
        /// <param name="cmdParms">参数</param>
        /// <returns>DataSet</returns>
        public static DataSet Query(string strSQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand();
        ...
        public static DataSet RunProcedure(string storedProcName, IDataParameter[] parameters, string tableName)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                sqlDA.Fill(dataSetInfo, tableName);
                connection.Close();
                return dataSetInfo;
            }
        }
        ...
        public static DataSet RunProcedure(string storedProcName,
            IDataParameter[] parameters, string tableName, int intTimes)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                DataSet dataSetInfo = new DataSet();
